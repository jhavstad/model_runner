...
class ScrolledFrame(MyPmwBase.MegaWidget):
    def __init__(self, parent = None, **kw):

	# Define the megawidget options.
	INITOPT = MyPmwBase.INITOPT
	optiondefs = (
	...
	MyPmwBase.MegaWidget.__init__(self, parent)

	# Create the components.
	self.origInterior = MyPmwBase.MegaWidget.interior(self)
	...
	if self.scrollTimer is not None:
	    ...
	    self.scrollTimer = None
	MyPmwBase.MegaWidget.destroy(self)
